    ...
    describe('Club Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/clubs';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Club', () => {
                service.create(new Club(null)).subscribe(received => {
            ...
            it('should update a Club', () => {
                service.update(new Club(123)).subscribe(received => {
